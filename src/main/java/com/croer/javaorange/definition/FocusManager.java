...
public class FocusManager {
    ...
    public FocusManager(Mediator testosMediator) {
        ...
        manager.addPropertyChangeListener("focusOwner", new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getNewValue() instanceof JComponent) {
                    ...
                    FocusManager.this.testosMediator.focusGained(component);
                }
        ...
        manager.addKeyEventDispatcher(new KeyEventDispatcher() {
            ...
            public boolean dispatchKeyEvent(KeyEvent e) {
                if (e.getID() == KeyEvent.KEY_PRESSED && (e.getKeyCode() == KeyEvent.VK_CONTROL || e.getKeyCode() == KeyEvent.VK_TAB)) {
                    return FocusManager.this.testosMediator.toogleView((JComponent) manager.getFocusOwner(), e);
                }
                return false;
            }
        });
